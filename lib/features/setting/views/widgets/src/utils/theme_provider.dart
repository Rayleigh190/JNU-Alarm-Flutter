...
class ThemeProvider {
  ...
  static SettingsThemeData _iosTheme({
    ...
    const lightSettingsListBackground = Color(0xFFF5F4F0);
    const darkSettingsListBackground = Color(0xFF121212);

    const lightSettingSectionColor = CupertinoColors.white;
    const darkSettingSectionColor = Color(0xFF282828);
    ...
    const darkLeadingIconsColor = Color(0xFFd3f392);
